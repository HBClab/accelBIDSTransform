...
# Timestamp: 2019-11-05 20:16:53 UTC
# 
...
RUN export PATH="/opt/miniconda-latest/bin:$PATH" \
    ...
    && conda env create -q --name accel --file /home/coder/project/environment.yml \
    && rm -rf ~/.cache/pip/*

RUN bash -c 'conda init && . /home/coder/.bashrc && . activate accel && pip install -e /home/coder/project'
...
RUN echo '{ \
    ...
    \n    [ \
    \n      "run_bash", \
    \n      "conda init && . /home/coder/.bashrc && . activate accel && pip install -e /home/coder/project" \
    \n    ], \
    \n    [ \
    \n      "run", \
