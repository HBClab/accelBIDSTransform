...
# This function queries redcap to get the participant id
# from a given lab id and project name
def redcap_query(lab_number, project_name, api_key):
    ...
    # AMBI subject id's need to be renamed
    if project_name == 'AMBI':
        subject_id = utils.ambi_adjust(subject_id)
